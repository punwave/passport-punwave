...
function Strategy(options, verify) {
  options = options || {};
  options.authorizationURL = options.authorizationURL || 'https://api.punwave.com/oauth/authorize';
  options.tokenURL = options.tokenURL || 'https://api.punwave.com/oauth/token';
  options.scopeSeparator = options.scopeSeparator || ',';

  OAuth2Strategy.call(this, options, verify);
  this.name = 'punwave';
  this._profileURL = options.profileURL || 'https://api.punwave.com/campaign/v2/users/me';
