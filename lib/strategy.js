...
function Strategy(options, verify) {
  options = options || {};
  options.authorizationURL = (options.beta) ? 'http://api.beta.punwave.com/oauth/authorize' : 'https://api.punwave.com/oauth/authorize';
  options.tokenURL = (options.beta) ? 'http://api.beta.punwave.com/oauth/token' : 'https://api.punwave.com/oauth/token';
  options.scopeSeparator = options.scopeSeparator || ',';

  OAuth2Strategy.call(this, options, verify);
  this.name = 'punwave';
  this._profileURL = (options.beta) ? 'http://api.beta.punwave.com/campaign/v2/users/me' : 'https://api.punwave.com/campaign/v2/users/me';
...
/**
 * Convert Punwave profile to a normalized profile.
 *
...
Strategy.prototype._convertProfileFields = function(profileFields) {
  ...
  profileFields.forEach(function(f) {
    // return raw Punwave profile field to support the many fields that don't
